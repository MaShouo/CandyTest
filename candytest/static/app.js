(() => {
  ...
  const questionDefaults = { candy: { rounds: 5, effort: "low" }, cup: { rounds: 2, effort: "medium" }, probability: { rounds: 5, effort: "medium" }, dag10: { rounds: 5, effort: "medium" }, thibault_sottiaux: { rounds: 3, effort: "low" } };
  ...
  function setQuestionDefaults() { const defaults = questionDefaults[$("#question").value]; $("#modelOverride").value = $("#question").value === "thibault_sottiaux" ? "gpt-6-astra" : ""; $("#rounds").value = defaults.rounds; $("#randomCandyFormat").style.display = $("#question").value === "candy" ? "" : "none"; setEfforts(defaults.effort); updateTestEstimate(); }
